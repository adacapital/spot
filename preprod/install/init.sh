...
wget -O cgenesis.json https://raw.githubusercontent.com/input-output-hk/cardano-world/8.x-integration/nix/cardano/environments/preprod/conway-genesis.json
