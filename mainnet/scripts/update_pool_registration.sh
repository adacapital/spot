...
if [[ $NODE_TYPE == "bp" && $IS_AIR_GAPPED == 0 && $STATE_STEP_ID == 3 && $STATE_SUB_STEP_ID == "init" ]]; then
    ...
    URL_TO_RAW_GIST_FILE="https://gist.githubusercontent.com/adacapital/581ae5434e59c79743b8c644a452de95/raw/a039c0fd5a995f04955563b96b03c4528d99e538/$GIST_FILE_NAME"
    META_URL="https://bit.ly/3nnt1ax"
